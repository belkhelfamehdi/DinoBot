    ...
    <div className="min-h-screen bg-gradient-to-b from-[#F5F0FF] via-[#FAF5FF] to-[#FFF8FF] flex flex-col">
      ...
      <div className="bg-gradient-to-r from-[#D8C8FF] to-[#E8D8FF] px-4 py-4 flex gap-3 justify-center sticky top-[57px] z-10 shadow-md">
        <button
          ...
          className={`px-5 py-2 rounded-full text-sm font-medium transition-all ${activeSubTab === "fiche"
        ...
        <button
          ...
          className={`px-5 py-2 rounded-full text-sm font-medium transition-all ${activeSubTab === "infos"
              ? "bg-white text-purple-700 shadow-md"
              : "bg-[#E8D8FF] text-purple-700 hover:bg-[#F0E4FF]"
            }`}
        >
                      ...
                      <div className="flex justify-center gap-2 mt-4">
                        {exampleCards.map((_, index) => (
                          <button
                            ...
                            className={`w-2 h-2 rounded-full transition-colors ${index === currentExampleCard ? "bg-gray-800" : "bg-gray-300"
                              }`}
                          />
                        ))}
                      </div>
                      ...
                      <div className="flex justify-center gap-2 mt-4">
                        {definitionCards.map((_, index) => (
                          <button
                            ...
                            className={`w-2 h-2 rounded-full transition-colors ${index === currentDefinitionCard ? "bg-gray-800" : "bg-gray-300"
                              }`}
                          />
                        ))}
                      </div>
                      ...
                      <div className="flex justify-center gap-2 mt-4">
                        {formulaCards.map((_, index) => (
                          <button
                            ...
                            className={`w-2 h-2 rounded-full transition-colors ${index === currentFormulaCard ? "bg-gray-800" : "bg-gray-300"
                              }`}
                          />
                        ))}
                      </div>
                      ...
                      <div className="flex justify-center gap-2 mt-4">
                        {revisionCards.map((_, index) => (
                          <button
                            ...
                            className={`w-2 h-2 rounded-full transition-colors ${index === currentRevisionCard ? "bg-gray-800" : "bg-gray-300"
                              }`}
                          />
                        ))}
                      </div>
                      ...
                      <div className="flex justify-center gap-2 mt-4">
                        {demoCards.map((_, index) => (
                          <button
                            ...
                            className={`w-2 h-2 rounded-full transition-colors ${index === currentDemoCard ? "bg-gray-800" : "bg-gray-300"
                              }`}
                          />
                        ))}
                      </div>
                      ...
                      <div className="flex justify-center gap-2 mt-4">
                        {errorCards.map((_, index) => (
                          <button
                            ...
                            className={`w-2 h-2 rounded-full transition-colors ${index === currentErrorCard ? "bg-gray-800" : "bg-gray-300"
                              }`}
                          />
                        ))}
                      </div>
